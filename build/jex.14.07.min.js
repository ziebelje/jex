...
jex.console.info=function(a){jex.console.add_to_buffer_("info",arguments);jex.console.flush_buffer_()};jex.console.time=function(a){jex.console.add_to_buffer_("time",arguments);jex.console.flush_buffer_()};jex.console.timeEnd=function(a){jex.console.add_to_buffer_("timeEnd",arguments);jex.console.flush_buffer_()};jex.console.group=function(){jex.console.add_to_buffer_("group",arguments);jex.console.flush_buffer_()};
jex.console.groupCollapsed=function(){jex.console.add_to_buffer_("groupCollapsed",arguments);jex.console.flush_buffer_()};jex.console.groupEnd=function(){jex.console.add_to_buffer_("groupEnd",arguments);jex.console.flush_buffer_()};jex.console.clear=function(){jex.console.add_to_buffer_("clear",arguments);jex.console.flush_buffer_()};jex.console.buffer_=[];jex.console.add_to_buffer_=function(a,b){jex.console.buffer_.push({console_function:a,console_arguments:b})};
