...
jex.hotkey.add=function(a){for(var b=[].concat(a.hotkey),c=[].concat(a.input||[]),d=0,e=c.length;d<e;++d)c[d]=c[d][0];for(var f,h,g,d=0,e=b.length;d<e;++d)f=jex.hotkey.normalize_(b[d]),h=a.callback,g=a.group||"",!1===jex.hotkey.hotkeys_.hasOwnProperty(g)&&(jex.hotkey.hotkeys_[g]={}),jex.hotkey.hotkeys_[g][f]={callback:h,inputs:c};jex.hotkey.check_listener_()};
...
jex.hotkey.reset_=function(){clearTimeout(jex.hotkey.sequence_timeout_handle_);jex.hotkey.current_hotkey_=""};
