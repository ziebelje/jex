...
nan:"#66d9ef","default":"#272822"}};
jex.prettyprint.prototype.decorate=function(a){var b=rocket.createElement("div");b.style({padding:"5px",background:this.color_scheme_.background||jex.prettyprint.default_background_color_});var c=rocket.createElement("table");c.style({"font-family":'Consolas, "Courier New", Courier, Monospace',"font-size":"14px"}).setAttribute({cellpadding:"0",cellspacing:"0"});var d=rocket.createElement("tbody");this.do_prettyprint_(this.object_,d);c.appendChild(d);b.appendChild(c);a.appendChild(b)};
