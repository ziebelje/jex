...
jex.table.prototype.add_row=function(a){var b=a||this.trs_.length;a=this.render_tr_("td",a);this.tbody_.insertBefore(a,this.trs_[b]);this.trs_.splice(b,0,a)};jex.table.prototype.remove_row=function(a){this.trs_[a].parentNode().removeChild(this.trs_[a]);this.trs_.splice(a,1);this.tds_.splice(a,1)};jex.table.prototype.table=function(){return this.table_};jex.table.prototype.tbody=function(){return this.tbody_};jex.table.prototype.tr=function(a){return this.trs_[a]};
